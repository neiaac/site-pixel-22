...
async function enrollParticipant(email, enrollment) {
    ...
    /*
    await updateDoc(doc(db, 'pixel', 'participants'), {
        [email]: enrollment
    })
        .then(() => { console.log('Successfully updated user code!'); return true; })
        .catch((e) => { console.log('Something went wrong! Here is the report: ', e); return false })
    */
}
